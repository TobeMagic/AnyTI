...
| 维度 | 覆盖题号 |
|---|---|
> v2.3：每题覆盖 2 个维度，每维度恰好由 6 题覆盖 [+1,+1,-1,-1] 均衡模式，确保每维度 EV=0。

| 维度 | 覆盖题号 |
|---|
| `attunement` | Q1, Q4, Q6, Q10, Q13, Q18 |
| `signal` | Q2, Q4, Q9, Q11, Q15, Q17 |
| `repair` | Q3, Q5, Q7, Q12, Q16, Q19 |
| `boundary` | Q1, Q6, Q8, Q10, Q13, Q16 |
| `certainty` | Q2, Q5, Q8, Q11, Q14, Q17 |
| `retreat` | Q3, Q7, Q9, Q12, Q15, Q19 |

> Q20 无维度覆盖（权重全为 0，安全兜底题）
...
| v2.3 | 2026-05-11 | 题目权重系统性重构：每题2维度覆盖，每维度 [+1,+1,-1,-1] 均衡模式，全部16人格去掉hiddenRule兜底，改用Softmax(temp=1.0)概率匹配，匹配率标准差从12.4%降至0.2%，各人格匹配率 [5.8%, 6.6%] 近似均匀分布 |
